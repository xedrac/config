...
(custom-set-faces
 ...
 '(neo-dir-link-face ((t (:foreground "SteelBlue1" :family "Liberation Mono"))))
 '(neo-file-link-face ((t (:foreground "light gray" :width narrow :family "Liberation Mono"))))
 '(neo-root-dir-face ((t (:foreground "sandy brown" :weight bold :family "Liberation Mono"))))
